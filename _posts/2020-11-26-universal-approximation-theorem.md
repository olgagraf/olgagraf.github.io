...
In order to get some intuition about this property, let's resort to a simple univariate example. Consider mapping $\gamma\left(f(x)\right)=f(x)-f\left({}^1{\mskip -0mu/\mskip -0mu}_2\right)$.
